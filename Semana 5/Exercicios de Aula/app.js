// "USE STRICT" (deve ficar no inicio do código)
"use strict";
...
//exemplo função efemera (ou anonima)
//a função esta encapsulada entre os parentesis, dessa forma mesmo sem ter um nome, ela é uma função válida. Ela pode ser executada imediatamente, sendo uma função de uso unico.
(function () {
